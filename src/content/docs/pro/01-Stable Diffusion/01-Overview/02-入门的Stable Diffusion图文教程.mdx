...
![30b169db-96f6-4d54-a0a8-25383a2c9404.webp](./images-02/30b169db-96f6-4d54-a0a8-25383a2c9404.webp)
...
![14.png](./images-02/14.png)

## 多 ControlNet 合成

在 ControlNet 的设置下，可以调整可用 ControlNet 的数量。

![15.png](./images-02/15.png)

在多个 ControlNet 模式下，结果会将输入的信息合并生成图像：

![16.png](./images-02/16.png)

![17.png](./images-02/17.png)
...
![18.png](./images-02/18.png)

- 大模型（Ckpt）：放入 models\Stable-diffusion

![19.png](./images-02/19.png)
...
![image.png](./images-02/image%2017.png)
